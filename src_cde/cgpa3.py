...
class cgpa3:
    ...
    def cg3(self):
        ...
        for i in range(1,no_of_grades+1):
            sum_up=((float(sem1_index[i-1])+float(sem2_index[i-1])+float(sem3_index[i-1]))/float(3))
